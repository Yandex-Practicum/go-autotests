...
- Зайдите в раздел "Безопасность" настроек системы и найдите раздел в котором написано: "Использование <имя файла> было заблокировано, так как оно не от идентифицированного разработчика".
